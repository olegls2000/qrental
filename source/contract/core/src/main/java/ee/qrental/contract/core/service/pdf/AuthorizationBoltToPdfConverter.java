...
/*
  ...
  */
        ...
        final var cell1 =
                new Cell(
                        new Paragraph("AUTHORIZATION", new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
        ...
        final var rendileandjacell2 =
                new Cell(new Paragraph("\nName Surname , ", new Font(Font.TIMES_ROMAN, 10, Font.BOLD)));
        ...
        final var rendileandjacell3 =
                new Cell(new Paragraph("\n EFFECTIVE ON THE DATE THIS DOCUMENT IS SIGNED, EXPRESSLY AUTHORISE " +
                        "THE FOLLOWING PERSONS: ", new Font(Font.TIMES_ROMAN, 9, Font.BOLD)));
        ...
        final var body1cell2 =
                new Cell(new Paragraph("Bolt Operations OÜ ",
                        new Font(Font.TIMES_ROMAN, 9, Font.BOLD)));
        ...
        final var body1cell4 =
                new Cell(new Paragraph("a company incorporated in the Republic of Estonia with company" +
        ...
        final var body1cell6 =
                new Cell(new Paragraph("CONSIDERING THAT: ",
                        new Font(Font.TIMES_ROMAN, 9, Font.NORMAL)));
        ...
        final var body1cell8 =
                new Cell(new Paragraph("I have entered into a [car rental/credit] agreement with Q TAKSO VEOD OÜ a company" +
        ...
        final var body1cell10 =
                new Cell(new Paragraph("I have accepted the Terms and Conditions for Drivers and I am using the Bolt Platform to" +
        ...
        final var body1cell12 =
                new Cell(new Paragraph("I have undertaken under the terms of my agreement with the Company to authorise Bolt" +
        ...
        final var body2cell2 =
                new Cell(new Paragraph("TO PERFORM THE FOLLOWING ACTIONS:",
                        new Font(Font.TIMES_ROMAN, 9, Font.BOLD)));
        ...
        final var body2cell4 =
                new Cell(new Paragraph("to deduct on a weekly basis my debt owed to the Company from my revenue earned" +
        ...
        final var body2cell6 =
                new Cell(new Paragraph("release to the Company on a weekly basis a file with the following personal details:",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell2 =
                new Cell(new Paragraph(" Bolt UUID; ",
                        new Font(Font.TIMES_ROMAN, 9, Font.NORMAL)));
        ...
        final var body3cell4 =
                new Cell(new Paragraph("Name and surname;",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell6 =
                new Cell(new Paragraph("Phone number;",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell8 =
                new Cell(new Paragraph("Transaction details, including reason for the failed transactions.",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell10 =
                new Cell(new Paragraph("upon request, provide access to the Company to personal details regarding my use of" +
        ...
        final var body3cell12 =
                new Cell(new Paragraph("my revenue earned via the Bolt Platform;",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell14 =
                new Cell(new Paragraph("my location during the provision of transportation services via the Bolt Platform;",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell16 =
                new Cell(new Paragraph("invoices issued to the customers on my behalf;",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell18 =
                new Cell(new Paragraph("my Bolt profile details;",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body3cell20 =
                new Cell(new Paragraph("statistics of my trips made via Bolt Platform, including driver score, percentage of" +
        ...
        final var body3cell22 =
                new Cell(new Paragraph("invoices issued to me by Bolt for the use of the Bolt platform.",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body4cell2 =
                new Cell(new Paragraph(" Once I revoke this authorisation, Bolt will  ",
                        new Font(Font.TIMES_ROMAN, 9, Font.BOLD)));
        ...
        final var body4cell4 =
                new Cell(new Paragraph("stop making any deductions from my revenue earned through the Bolt Platform in favor of the Company and ",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
        ...
        final var body4cell6 =
                new Cell(new Paragraph("stop releasing my personal details to the Company. Nevertheless, revoking" +
        ...
        final var body5cell2 =
                new Cell(new Paragraph("By signing this authorisation, I confirm and understand that I am solely responsible for" +
        ...
        final var body5cell4 =
                new Cell(new Paragraph("Bolt is not liable for the debt owed by me to the Company or any other obligations I have" +
        ...
        final var signaturecell6 =
                new Cell(new Paragraph(" Driver’s name and surname (and if applicable, company name)",
                        new Font(Font.TIMES_ROMAN, 8, Font.NORMAL)));
       // signaturecell6.setColspan(2);
        ...
        final var signaturecell8 =
                new Cell(new Paragraph("__________________________________________________________________________________      _______________  ",
                        new Font(Font.TIMES_ROMAN, 9, Font.BOLD)));
        ...
        final var signaturecell10 =
                new Cell(new Paragraph("Signature                                                                                 Date              ",
                        new Font(Font.TIMES_ROMAN, 9, Font.NORMAL)));
