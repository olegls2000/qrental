...
import static ee.qrental.email.api.in.request.EmailType.CALCULATION;
...
@AllArgsConstructor
public class CalculationLetterBuildStrategy implements LetterBuildStrategy {

  private final TemplateEngine templateEngine;

  @Override
  public boolean canApply(EmailSendRequest emailSendRequest) {
    return CALCULATION == emailSendRequest.getType();
  }
  ...
  private String getEmailText(Map<String, Object> properties) {
    final var invoiceTemplate = "calculationMailTemplate";
