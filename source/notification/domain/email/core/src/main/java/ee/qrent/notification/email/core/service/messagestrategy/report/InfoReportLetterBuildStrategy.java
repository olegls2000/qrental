...
import static ee.qrent.notification.email.api.in.request.EmailType.INFO_REPORT_EMAIL;
...
public class InfoReportLetterBuildStrategy extends AbstractReportLetterBuildStrategy {

  public InfoReportLetterBuildStrategy(final TemplateEngine templateEngine) {
    super(templateEngine);
  }

  @Override
  public boolean canApply(final EmailSendRequest emailSendRequest) {
    return INFO_REPORT_EMAIL == emailSendRequest.getType();
  }
