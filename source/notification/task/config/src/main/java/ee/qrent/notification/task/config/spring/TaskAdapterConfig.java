...
import ee.qrent.notification.task.persistence.adapter.TaskRunResultLoadAdapter;
import ee.qrent.notification.task.persistence.adapter.TaskRunResultPersistenceAdapter;
