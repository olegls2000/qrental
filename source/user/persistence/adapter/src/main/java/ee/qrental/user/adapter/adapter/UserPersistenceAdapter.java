...
@AllArgsConstructor
public class UserPersistenceAdapter implements DriverAddPort, DriverUpdatePort, DriverDeletePort {

  private final UserRepository driverRepository;
  private final UserAdapterMapper driverAdapterMapper;
  ...
  private DriverJakartaEntity updateSavedEntity(
    ...
    entity.setIsikukood(domain.getIsikukood());
