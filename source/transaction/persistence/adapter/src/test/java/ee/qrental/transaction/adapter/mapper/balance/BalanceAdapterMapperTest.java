...
class BalanceAdapterMapperTest {
  ...
  public void testIfMapEntityToDomainIsNull() {
    ...
    // given
    final BalanceJakartaEntity domain = null;
  ...
  public void testShouldMapToEntitySuccessfully() {
    ...
    // then
    assertEquals(
        "Balance{id=3, driverId=5, qWeekId=45, created=2024-02-21, feeAbleAmount=10.5, nonFeeAbleAmount=5.1, feeAmount=8.1, repairmentAmount=25.9, positiveAmount=2.7, derived=true}",
        stringBalance);
