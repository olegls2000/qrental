...
public class ContractToPdfConversionStrategyAfter11January2026ForFieFor12Weeks
    extends AbstractContractToPdfConversionStrategy {

  public ContractToPdfConversionStrategyAfter11January2026ForFieFor12Weeks(
  ...
  public InputStream getPdfInputStream(final ContractPdfModel model) {
    ...
    chapter1.addCell(
        getSubChapterText(
            "Käesoleva lepingulisa eestikeelne tekst on saadaval järgmisel lingil: "  // Ссылка на страничку на сайте с эстонским текстом из типовых условий.
                    + "https://qrent.ee/tuuptingimused/tt_fie_pdf_est"));
    ...
    chapter1.addCell(
        getSubChapterText(
            "Käesoleva lepingulisa venekeelne (по-русски) tekst on saadaval järgmisel lingil: " //  Ссылка на страничку на сайте с русским переводом.
                + "https://qrent.ee/tuuptingimused/tt_fie_pdf_rus"));
    ...
    chapter1.addCell(
            getSubChapterText(
                    "Käesoleva lepingulisa inglisekeelne (in English) tekst on saadaval järgmisel lingil: " //  Ссылка на страничку на сайте с английским переводом.
                            + "https://qrent.ee/tuuptingimused/tt_fie_pdf_eng"));
    ...
    chapter2.addCell(
        getSubChapterText(
            "Käesoleva lepingulisa eestikeelne tekst on saadaval järgmisel lingil: "  //  Ссылка на страничку на сайте с эстонским текстом из типовых условий.
                    + "https://qrent.ee/tsk/tsk_fie_pdf_est"));

    chapter2.addCell(getSubChapterNumber("2.1.2"));
    chapter2.addCell(
        getSubChapterText(
            "Käesoleva lepingulisa venekeelne (по-русски) tekst on saadaval järgmisel lingil: "  //  Ссылка на страничку на сайте с русским переводом.
                + "https://qrent.ee/tsk/tsk_fie_pdf_rus"));
    ...
    chapter2.addCell(
        getSubChapterText(
            "Käesoleva lepingulisa inglisekeelne (in English) tekst on saadaval järgmisel lingil:" //  ССсылка на страничку на сайте с английским переводом.
                + "https://qrent.ee/tsk/tsk_fie_pdf_eng"));
    ...
    chapter5.addCell(
        ...
        +" https://qrent.ee/koostleping_fie_pdf_rus"));        //    Ссылка на страничку на сайте с русским переводом.\n"));

    chapter5.addCell(getSubChapterNumber("5.6.2"));
    chapter5.addCell(
            getSubChapterText(
                    "Käesoleva lepingu inglisekeelne (in English) tekst on saadaval järgmisel lingil:"
            +" https://qrent.ee/koostleping_fie_pdf_eng"));     //    Ссылка на страничку на сайте с английским переводом.\n"));
