...
public class ContractToPdfConversionStrategyAfterMay2025ForAllDrivers
  ...
  public InputStream getPdfInputStream(final ContractPdfModel model) {
    ...
    chapter3.addCell(
        getSubChapterText(
            "Juhul, kui Rentnikul on eelmise perioodi võlgnevusi, kohustub ta tasuma kehtivale nädalasele rendihinnale lisaks 25% rendiauto üleandmise-vastuvõtmisaktis märgitud " +
                    "baasilisest rendihinnast (enne boonuste ja allahindluste rakendamist) võlgnevuse osaliseks katteks."));
