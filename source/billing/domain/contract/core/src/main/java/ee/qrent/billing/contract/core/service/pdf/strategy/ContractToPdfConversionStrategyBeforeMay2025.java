...
public class ContractToPdfConversionStrategyBeforeMay2025
    extends AbstractContractToPdfConversionStrategy {

  public ContractToPdfConversionStrategyBeforeMay2025(ContractLoadPort loadPort) {
    super(loadPort);
  }
  ...
  public boolean canApply(final ContractPdfModel model) {
    ...
    return isContractBeforeNewContractDate(model);
  }
