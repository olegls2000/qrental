...
public class ContractToPdfConversionStrategyFrom1May2024
  ...
  public InputStream getPdfInputStream(final ContractPdfModel model) {
    ...
    chapter1.addCell(
        getSubChapterText(
            "Kõik käesoleva lepingu ja “Tüüptingimused” lepingulisa tingimuste muudatused jõustuvad kaks täispika kalendrinädalat pärast nendest " +
                    "  Rentniku teavitamist, välja arvatud juhul, kui muudatuses on sätestatud teisiti."));

    chapter1.addCell(getSubChapterNumber("1.8"));
    chapter1.addCell(
            getSubChapterText(
                    " Rentnik on kohustatud tutvuma käesoleva lepingu ja “Tüüptingimused” lepingulisa muudatustega ning kinnitama nendega nõustumist kahe täispika " +
                            "kalendrinädala jooksul pärast teavitamise saamist. Kui Rentnik ei nõustu muudatustega, on tal õigus lepingu üles öelda käesoleva lepingu punktis 1.14 sätestatud tingimustel.   "));
    ...
    chapter1.addCell(
            getSubChapterText(
                    " Kui ei ole Rentnik käesoleva lepingu ja “Tüüptingimused” lepingulisa tingimuste muudatustega tutvunud ega pole oma nõusolekut muudatustega kahe täispika kalendrinädalate " +
                            "jooksul alates teavitamisest kinnitanud, loetakse, et on ta need tingimused vastu võtnud.     "));

    chapter1.addCell(getSubChapterNumber("1.11"));
    chapter1.addCell(
            getSubChapterText(
                    " Rendileandja ja Rentnik sõlmivad käesoleva lepingu oma majandustegevuse raames, mille alusel on Rentnikul õigus võtta renti igat hõivatumata autot Rendileandja autopargist oma tulu teenimise eesmärgil," +
                            " s.o taksoteenuste osutamiseks. Vastavalt käesolevale rendilepingule kohustub Rendileandja andma Rentnikule kasutada käesolevas lepingus, selle “Tüüptingimused” lepingulisas ning " +
                            "üleandmise-vastuvõtmise aktis määratud rendieseme (hõivatumata auto Rendileandja autopargist, kui see on olemas). Selle eest on Rentnik kohustatud tasuma Rendileandjale renditasu (rent) kogu rendiperioodi eest.     "));

    chapter1.addCell(getSubChapterNumber("1.12"));
    chapter1.addCell(
            getSubChapterText(
                    " Oma allkirjaga kinnitab Rentnik, et on ta teadlik ja nõustub, et iga renditud auto täispika kalendrinädala rendimaksumus on määratud vastavas üleandmise-vastuvõtmise aktis ning et tuleb nimetatud tasu tasuda " +
                            "õigeaegselt ja täies ulatuses (kehtiva rendinädala Teisipäeva kella 16:00’ni).      "));
    ...
    chapter1.addCell(
            getSubChapterText(
                    " Rentnik kinnitab oma allkirjaga tema nõusolekut osaleda Rendileandja korraldatavates boonuskampaaniates. Nende boonuskampaaniate toimumise ajad ja tingimused ei ole eelnevalt kindlaks määratud " +
                            "ning Rentnik nõustub, et Rendileandja võib nende toimumisel ja Rentniku vastuväidete puudumisel teha korrigeerivaid kandeid Rentniku saldole. " +
                            "Rentnik tunnistab, et selliste boonuskannete tegemine ei ole Rendileandja kohustus ning Rendileandja võib neid igal ajal omal äranägemisel alustada, " +
                            "jätkata või lõpetada. Samal ajal, käesoleva kalendrinädala mistahes boonuskampaania aktiveerimise tingimusteks on Rentnikupoolne õigeaegne ja täielik eelmise " +
                            "nädala renditasu tasumine ning käesolevas lepingus määratud võlakohustuste osa hüvitamine (hüvitamise kord on kirjeldatud punktides 3.4 ja 3.5).     "));
//TODO 12 4
    chapter1.addCell(getSubChapterNumber("1.13"));
    chapter1.addCell(
            getSubChapterText(
                    " Käesolev leping on tähtajatu. Samal ajal, Rendileandja poolt käesoleva koostöölepingu alusel osutatava renditeenuse miinimumperiood on kaksteist (neli)" +
                            " järjestikut täispika kalendrinädalat, mille eest peab renditeenuse maksumus olema tasutud. Renditeenuse osutamise miinimumperioodi arvestus algab kuupäevast," +
                            " mis on määratud käesoleva lepingu alusel koostatud esimese rendiauto üleandmise-vastuvõtmise aktis, juhul kui see akt allkirjastatakse lepingu sõlmimise päeval " +
                            "või hiljem. Kui Rentnikul on lepingu allkirjastamise hetkel Rendileandja rendiauto juba kasutuses, algab miinimumperioodi arvestus käesoleva lepingu allkirjastamise kuupäevast."));
//TODO 12 4
    chapter1.addCell(getSubChapterNumber("1.14"));
    chapter1.addCell(
            getSubChapterText(
                    " Rentnikul on õigus lepingu igal ajal ja mistahes põhjusel lõpetada. Lepingu lõpetamiseks kohustub Rentnik teavitama Rendileandjat kirjalikult, kasutades rendilepingus määratud " +
                            "e-posti aadressi, vähemalt neli (kaks) täispika kalendrinädalat enne rendiauto tagastamist. Auto tagastamise tingimused on kirjeldatud “Tüüptingimused” lepingulisa punktides 4.3 ja 4.4." +
                            " Pärast seda, kui on Rentnik Rendileandja käesoleva rendilepingu lõpetamise soovist teavitanud, tekib Rentnikul õigus lõpetada lepingualuse autorenditeenuse kasutamise nelja (kahe)" +
                            ...
                            "(neli (kaks) täispika kalendrinädalat) ja vastavalt punktides 3.4 ja 3.5 sätestatud tingimustele. Rentnikul on õigus kasutada rendiautot kogu nimetatud perioodi vältel vastavalt " +
                            "lepingu punktides 4.4, 4.4.1 ja 4.4.2 kirjeldatud tingimustele. Kui Rentnik tagastab rendiauto enne tähtaega, kohustub ta tasuma kogu kasutamata rendiperioodi eest vastavalt " +
                            "selle auto üleandmise-vastuvõtmise aktis määratud rendimaksumusele.     "));
    ...
    chapter2.addCell(
        getSubChapterText(
            "Samuti kinnitab Rentnik, et on ta teadlik sellest, et \"TSK tingimused\" lepingulisa sätestatud tingimuste rikkumisel, kaotab TSK oma kehtivuse. Rentniku kohustus hüvitada rendiperioodi ajal rendiautole tekitatud kahju" +
                    " ja selle ulatus arvutatakse siis vastavalt käesolevas lepingus ja lepingulisa \"Tüüptingimused\" tingimustes sätestatule."));
    ...
    chapter3.addCell(
        getSubChapterText(
            "Rentnik kohustub tasuma Rendileandjale ettemaksu iga täispika kalendri rendinädala eest, vastavalt summale, mis on määratud üleandmise-vastuvõtmise aktile, kas sularahas Rendileandja kontoris, " +
                    "mis asub aadressil Lasnamäe 30a, Tallinn, või ülekandega Rendileandja pangakontole (või muule Rendileandja esindaja poolt määratud kontole) asjakohase selgitusega „autorent + auto number“. " +
    ...
    chapter3.addCell(
        getSubChapterText(
            "Käesoleva lepingu allkirjastamisega nõustub Rentnik, et Rendileandjal on õigus nõuda Rentniku eelnevalt teenitud, mittekasutatud ja mitteäravõetud vahendeid Rentniku kontolt " +
                    "taksotellimuste vahendamise rakendustes, nagu näiteks Bolt, Forus, Uber, kuid mitte ainult need, et katta Rentniku Rendileandja ees olevaid autorendi- ja võlakohustusi. " +
                    "Rendileandja kohustub tagama, et seda õigust ei kasutata ebaseaduslikel ega muudel eesmärkidel, mis ei vasta käesolevas paragrahvis kirjeldatud eesmärkidele, " +
                    "ning vajadusel esitab Rentnikule või rakenduse-põhisele teenusepakkujale arvestuse, mille järgi on nõutud vahendid kasutatud. Võimalikuks nõudmiseks kokkulepitud vahendite s" +
                    "umma on määratud punktides 3.4 ja 3.5, eelnevalt kokkulepitud Rentniku ja Rendileandja vahel ning Rentnik kinnitab, et on sellega nõus. Käesolev õigus kehtib vaid käesoleva " +
                    "lepingu kehtivuse ajal ja Rentniku poolt Rentileandja auto rentimisel, kui pooled ei ole kokku leppinud teisiti."));
    ...
    chapter3.addCell(
        getSubChapterText(
            "Rendileandjal on õigus taotleda raha väljavõtmise piiramist Rentniku bilanssilt taksoteenuste rakendustes (nt Bolt, Forus, Uber jne) ühe korraga nädalas – ainult nädala esimesel" +
                    " tööpäeval (tavaliselt esmaspäeval), välja arvatud juhul, kui ametlikud puhkepäevad määravad teisiti. Piirangut saab taotleda ainult Rendileandja algatusel, " +
                    "ning Rentnik ei saa ise taotleda selliseid muudatusi oma konto toimimises käesoleva lepingu kehtivuse ajal ja tema poolt Rentileandja auto rentimisel. " +
                    "Rentnik kinnitab, et ta aktsepteerib käesolevas paragrahvis kirjeldatud tingimused ja on nendega tingimusteta nõus;"));
    ...
    chapter4.addCell(
        getSubChapterText(
            "Rentniku kohustuste võlalimiit Rendileandja ees on 240 eurot, mille ületamisel on Rentnikul tema võlgnevuse kõrvaldamiseks 7 päeva pärast esimest Esmaspäeva, millal on käesolev " +
                    "võlg tekkinud. Juhul, kui Rentniku võlgnevus ei ole 7 päeva möödumisel kõrvaldatud, tekib Rendileandjal õigus käesoleva " +
                    "lepingualuse renditeenuse osutamine peatada ja lugeda lepingu Rendija poolt oluliselt rikutuks."));

    chapter4.addCell(getSubChapterNumber("4.4.1"));
    chapter4.addCell(
            getSubChapterText(
                    " Rentnikupoolsel käesoleva lepingu punktis 4.4 ja “Tüüptingimused” lepingulisa punktis III sätestatud tingimuste olulisel rikkumisel jätab Rendileandja endale õigust oma " +
                            "äranägemisel otsustada, kas peatada rendiauto funktsionaalsuse Rentniku rahalise olukorra paranemiseni või lõpetada Rentnikule osutatava renditeenuse ja kõrvaldada rendiauto tema kasutusest.     "));


    chapter4.addCell(getSubChapterNumber("4.4.2.1"));
    chapter4.addCell(
            getSubChapterText(
                    " Rentnik on kohustatud toimetama rendiauto ülevaatuseks 3 tunni jooksul peale vastava nõude saamist Rentniku kontorisse aadressil Lasnamäe 30a, Tallinn, " +
                            "kui selline nõue on esitatud Rentnikul hiljemalt kella 15:00’ni tööpäeval või hiljemalt kella 11:00’ni laupäeval. Kui nõue esitati hiljem kui eelnevas lauses näidatud ajaks, " +
                            "on Rentnik kohustatud tooma sõiduki kontrolliks järgmisel päeval v.a. Põhapäeva. Kui Rentnik ei täida seda tingimust õigeks ajaks vääramatu jõu puudumisel, " +
                            "on Rendileandjal õigus nõuda Rentnikult trahvi summas 30 eurot selle ja iga sellise kordava juhtumi eest.     "));
    chapter4.addCell(getSubChapterNumber("4.4.2.2"));
    chapter4.addCell(
            getSubChapterText(
                    " Rentnik on kohustatud tagastama Sõiduki Rendileandjale samadel tingimustel, mis on sätestatud käesoleva lepingu punktis 4.4.2.1, vastava nõude saamisel juhul," +
                            " kui Rentnik on oluliselt rikkunud käesoleva lepingu punktis 4.4 sätestatud renditingimused. Kui Rentnik ei täida seda tingimust õigeks ajaks vääramatu jõu puudumisel, " +
                            "on Rendileandjal õigus nõuda Rentnikult trahvi summas 120 eurot iga ööpäeva eest, mis on möödunud alates sellise nõude saamisest Rentniku poolt.     "));
    chapter4.addCell(getSubChapterNumber("4.4.2.3"));
    chapter4.addCell(
            getSubChapterText(
                    "  Rentnik on kohustatud toimetama rendiauto tehnilisele hooldusele SMS-sõnumis ja/või e-kirjas märgitud ajaks, mis on talle saadetud käesolevas lepingus märgitud kontaktandmete alusel." +
                            " Hooldus toimub aadressil Lasnamäe 30a, Tallinn, Brisko OÜ töökojas. Pooled on kokku leppinud, et eelmainitud teade ei tohi olla saadetud varem kui 18 tundi enne hoolduse toimumise aega." +
                            " Juhul kui Rentnik ei saa tuua sõidukit hooldusesse määratud ajaks, on ta kohustatud sellest teatama hiljemalt 3 tunni jooksul pärast vastava teate saamist ja " +
                            "mitte hiljem kui teate saamise päeval kell 18:00. Kui Rentnik ei täida seda tingimust õigeks ajaks vääramatu jõu puudumisel, on Rendileandjal õigus nõuda Rentnikult trahvi summas 30 eurot.    "));

   //TODO 12 4
    chapter4.addCell(getSubChapterNumber("4.4.3"));
    chapter4.addCell(
            getSubChapterText(
                    " Käesoleva lepingu allkirjastamisega kinitab Rentnik, et on ta teadlik ja nõus järgmise tingimusega: Käesolevas lepingus punktis 4.4.1 kirjeldatud tingimuste loomine " +
                            "ja järgneva rendiauto kõrvaldamine Rentniku kasutusest võrdsustatakse Rentniku poolt lepingu lõpetamisest teatamisega, mis on kirjeldatud käesoleva lepingu punktis 1.14. " +
                            "Seetõttu jõustub käesoleva lepingu punktis 1.14 toodud tingimus, mis kohustab Rentnikku tasuma renditasu järgnevate nelja (kahe) täispika kalendrinädala eest pärast " +
                            "eespool kirjeldatud Rentniku poolt lepingu lõpetamisest teatamist.     "));

    chapter4.addCell(getSubChapterNumber("4.4.4"));
    chapter4.addCell(
            getSubChapterText(
                    " Peale selle, Rentnikupoolse eelnevas punktis 4.4.1 kirjeldatud tingimuste loomise ja sellele järgneva rendiauto kõrvaldamise eest määratakse rahatrahv summas 500 eurot, " +
                            "kui rendiauto kõrvaldamise ajal asub Tallinnas. Kui rendiauto kõrvaldamise ajal asub Tallinnast väljaspool, lisatakse trahvi summale veel 2 eurot iga kilomeetri " +
                            "eest Tallinna piirist auto asukohani. Kui auto kõrvaldamise ajal ei ole sõiduk liiklemiskõlblik, lisatakse ülaltoodud summadele evakuaatori tasu.     "));
    chapter4.addCell(getSubChapterNumber("4.4.5"));
    chapter4.addCell(
            getSubChapterText(
                    " Rendiauto võib olla tagastatud Rentnikule kasutamiseks, kui kõrvaldamise põhjuseks oli vaid võlgnevus Rendileandja ees, mis hiljem hüvitati." +
                            " Sellisel juhul ei kompenseerita Rentnikule aega, mille jooksul rendiauto oli Rendileandja valduses, vaid peab see olema tasutud vastavalt " +
                            "käesoleva lepingu punktides 3.4 ja 3.5 kirjeldatud tingimustele. Sel juhul tagastatakse auto Rentnikule “Tüüptingimused” lepingulisa punktis 4.1 määratud väljastamiskohas.      "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " Rentniku käesoleva lepingualune seaduslik esindaja või tegelik kasusaaja (Uus Rentnik 12345678910) avaldab ja kinnitab oma allkirjaga tingimusteta, " +
                            "et ta käendab käesolevas lepingus (majandustegevuse raames) tekkivaid kohustusi. Käendaja tagab nimetatud lepingus sätestatud kohustuste täitmise antava käendusega. " +
                            "Pooled kinnitavad, et nad ei käsitle käesoleva lepingu alusel antud käendust tarbijakäendusena võlaõigusseaduse tähenduses. Käendaja vastutab Rendileandja " +
                            "ees täies ulatuses solidaarselt, tagades kõiki Rendileandja nõudeid Rentniku vastu, mis tekivad või võivad tekkida käesoleva lepingu alusel.     "));
    chapter4.addCell(getSubChapterNumber("4.6.2"));
    chapter4.addCell(
            getSubChapterText(
                    " Pooled on leppinud kokku, et käendaja maksimaalne vastutuse piir mootorsõidukile tekitatud kahjustuste eest on kuni kaksteist tuhat eurot, " +
                            "juhul kui autole tekitatud kahjustused ei kuulu täiendava sisemise kindlustuse (TSK) alla ega ole piiratud maksimaalse frantsiisi summaga," +
                            " mis on 600 eurot. See vastutuse piirang kehtib ainult siis, kui kõik järgmised tingimused on täidetud:     "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " Auto juht oli alkoholi- või uimastimõju all.     "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " Korduv liiklusreeglite rikkumine (nt pidev kiiruseületamine).     "));
    chapter4.addCell(getSubChapterNumber("4.6.3.4"));
    chapter4.addCell(
            getSubChapterText(
                    " Reeglite rikkumine oli teadlik ja tahtlik.  "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    "Autot kasutati lepingutingimustele vastuolulisel eesmärgil. "));
    chapter4.addCell(getSubChapterNumber("4.6.3.7"));
    chapter4.addCell(
            getSubChapterText(
                    " Rendniku juhiluba oli aegunud või kehtetu.     "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " Rendnik alustas parandustöid ilma rendiandja nõusolekuta.     "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " Intresside, viiviste ja trahvide tasumise,     "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " Lepingu ülesütlemise või tagasivõtmisega seotud kulud,     "));
    chapter4.addCell(getSubChapterNumber("4.6.4.4"));
    chapter4.addCell(
            getSubChapterText(
                    " Võla sissenõudmise kulud     "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " Selle lepingu allkirjastamisega kinnitab Rentnik, et:     "));
    ...
    chapter4.addCell(
            getSubChapterText(
                    " See seade võimaldab vajadusel kindlaks teha sõiduki asukoha;     "));
    chapter4.addCell(getSubChapterNumber("4.10.3"));
    chapter4.addCell(
            getSubChapterText(
                    " Seadmest saadud andmeid võib kasutada kohtumenetluses.     "));
