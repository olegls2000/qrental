...
public class ContractToPdfConversionStrategyAfter11January2026ForOuFor12Weeks
    extends AbstractContractToPdfConversionStrategy {

  public ContractToPdfConversionStrategyAfter11January2026ForOuFor12Weeks(
  ...
  public boolean canApply(final ContractPdfModel model) {
    ...
    return isContractAfterNew1ContractDateForCompany(model) && isContractFor12Weeks(model);
  }
