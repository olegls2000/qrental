...
public class WeeklyReportToPdfModelMapper {
    ...
    public WeeklyReportPdfModel getPdfModel(final WeeklyReport report) {
        ...
        final var carReg = report.getCarId() != null ? carQuery.getById(report.getCarId()).getRegNumber() : null;
        ...
        return WeeklyReportPdfModel.builder()
                ...
                .obligationStatus(report.getObligationStatus() != null ? report.getObligationStatus().name() : null)
                .comment(report.getComment())
                // amount: prefer balance at calculation moment, fallback to balance on Sunday
                .amount(report.getBalanceAmountAtCalculationMoment() != null
