...
@UtilityClass
public class WeeklyReportFridayPdfLabelProvider {
  ...
  static {
    mapRus =
        Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>(
                REPORT_NAME_KEY, "РАССЫЛКА НА ЧЕТВЕРГ - 18:00"), // ВТОРНИК - 10:00
            ...
            new AbstractMap.SimpleEntry<>(
                THURSDAY_LABEL_KEY, "Отчет по оплате и бонусам:"),
            new AbstractMap.SimpleEntry<>(OBLIGATION_TEXT_PART_1_LABEL_KEY, "Ты"),
            new AbstractMap.SimpleEntry<>(
                OBLIGATION_TEXT_PART_2_COMPLETED_LABEL_KEY, "выполнил(а)"), // Добавить текст " Поздравляем - "
            new AbstractMap.SimpleEntry<>(
                OBLIGATION_TEXT_PART_2_NOT_COMPLETED_LABEL_KEY, "не выполнил(а)"),  //  Добавить текст. "Сообщаем, что, к сожалению, "
            ...
            new AbstractMap.SimpleEntry<>(
                THURSDAY_BALANCE_TEXT_PART_3_LABEL_KEY, "четверга текущей  недели:"),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_ACTIVE_TEXT_PART_1_LABEL_KEY, "Так держать! \n В знак нашей благодарности"),
            new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_INACTIVE_TEXT_PART_1_LABEL_KEY, "По этой причине мы не можем "),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_INACTIVE_TEXT_PART_2_LABEL_KEY, "активировать "),
            new AbstractMap.SimpleEntry<>(BONUS_PROGRAM_INACTIVE_TEXT_PART_3_LABEL_KEY, "наши "),
            new AbstractMap.SimpleEntry<>(BONUS_PROGRAM_INACTIVE_TEXT_PART_4_LABEL_KEY, "бонусные кампании "),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_INACTIVE_TEXT_PART_5_LABEL_KEY, "на следующей неделе."),
       ...
       //     new AbstractMap.SimpleEntry<>(
        //        OBLIGATION_HEADER_TEXT_PART_2_LABEL_KEY, "твоим обязательствам"),
            ...
            new AbstractMap.SimpleEntry<>(
                COMMENT_LABEL_KEY,
                "\n"
                    + "Данные в этой рассылке являются информативными, сами по себе не налагают ни на одну из сторон "
                    + "никаких обязательств и меняются по мере занесения их в систему."),
            new AbstractMap.SimpleEntry<>(
                RENT_ADJUSTMENT_LABEL_KEY, "Коррекция аренды и прочие поступления: "),
    ...
    mapEng =
        Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>(
                OBLIGATION_TEXT_PART_2_COMPLETED_LABEL_KEY, "have fulfilled"), // Добавить текст " Congratulations  - "
            new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(
                OBLIGATION_TEXT_PART_5_LABEL_KEY, "for the current  week"),
            new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(
                THURSDAY_BALANCE_TEXT_PART_3_LABEL_KEY, "end of Thursday this  week was:"),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_ACTIVE_TEXT_PART_1_LABEL_KEY, "Keep it up! \n As a token of our appreciation,"),
            new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_INACTIVE_TEXT_PART_5_LABEL_KEY, "for the upcoming  week."),
          ...
          /*  new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(
                COMMENT_LABEL_KEY,
                "\n"
                    + "The data in this newsletter is for informational purposes only, does not in itself create any "
                    + "obligations for either party, and may change as new information is entered into the system."),
            new AbstractMap.SimpleEntry<>(
                RENT_ADJUSTMENT_LABEL_KEY, "Rental fee adjustment and other income: "),
            new AbstractMap.SimpleEntry<>(RENT_ADJUSTMENT_BOLT_INCOME_1_LABEL_KEY, "Earnings "),
            new AbstractMap.SimpleEntry<>(RENT_ADJUSTMENT_BOLT_INCOME_2_LABEL_KEY, "Bolt"),
            new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(
                DEMAND_ON_BEGINNING_OF_WEEK_LABEL_KEY, "Other obligations (report): "),
    ...
    mapEst =
        Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>(OBLIGATION_TEXT_PART_2_COMPLETED_LABEL_KEY, "oled täitnud oma "), // Добавить текст " Palju õnne  - "
            new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(OBLIGATION_TEXT_PART_5_LABEL_KEY, "käesoleval nädalal "),
            new AbstractMap.SimpleEntry<>(
                OBLIGATION_TEXT_PART_6_LABEL_KEY, "õigeaegselt ja täies mahus."),
            new AbstractMap.SimpleEntry<>(
                THURSDAY_BALANCE_TEXT_PART_1_DEBT_LABEL_KEY, "Sinu võlg eelmise"),
            new AbstractMap.SimpleEntry<>(
                THURSDAY_BALANCE_TEXT_PART_1_PREPAYMENT_LABEL_KEY, "Sinu ettemakse käesoleva "),
            new AbstractMap.SimpleEntry<>(THURSDAY_BALANCE_TEXT_PART_2_LABEL_KEY, "nädala"),
            new AbstractMap.SimpleEntry<>(
                THURSDAY_BALANCE_TEXT_PART_3_LABEL_KEY, "neljapäeva lõpuks on"),
            new AbstractMap.SimpleEntry<>(BONUS_PROGRAM_ACTIVE_TEXT_PART_1_LABEL_KEY, "Jätka samas vaimus! \n Tänutäheks"),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_ACTIVE_TEXT_PART_2_LABEL_KEY, "oleme aktiveerinud "),
            new AbstractMap.SimpleEntry<>(BONUS_PROGRAM_ACTIVE_TEXT_PART_3_LABEL_KEY, "kõik meie "),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_ACTIVE_TEXT_PART_4_LABEL_KEY, "boonuskampaaniad "),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_ACTIVE_TEXT_PART_5_LABEL_KEY, "järgmiseks nädalaks."),
            new AbstractMap.SimpleEntry<>(
                    BONUS_PROGRAM_INACTIVE_TEXT_PART_1_LABEL_KEY, "Seetõttu "),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_INACTIVE_TEXT_PART_2_LABEL_KEY, "ei saa me järgmisel"),
            new AbstractMap.SimpleEntry<>(
                    BONUS_PROGRAM_INACTIVE_TEXT_PART_3_LABEL_KEY, "nädalal "),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_INACTIVE_TEXT_PART_4_LABEL_KEY, "aktiveerida "),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_INACTIVE_TEXT_PART_5_LABEL_KEY, "meie boonuskampaaniaid."),
        ...
        /*    new AbstractMap.SimpleEntry<>(
            ...
            new AbstractMap.SimpleEntry<>(
                COMMENT_LABEL_KEY,
                "\n"
                    + "Selles infokirjas esitatud andmed on informatiivse iseloomuga, ei sea iseenesest kummalegi "
                    + "poolele mingeid kohustusi ning võivad muutuda vastavalt andmete sisestamisele süsteemi."),
            new AbstractMap.SimpleEntry<>(
