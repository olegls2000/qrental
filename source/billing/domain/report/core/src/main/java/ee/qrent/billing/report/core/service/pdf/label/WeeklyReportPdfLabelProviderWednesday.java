...
@UtilityClass
public class WeeklyReportPdfLabelProviderWednesday {
  ...
  static {
    mapRus =
        Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>(THURSDAY_LABEL_KEY, "Отчет по оплате и бонусам:"),
            new AbstractMap.SimpleEntry<>(
                BONUS_PROGRAM_ACTIVE_TEXT_PART_1_LABEL_KEY,
  ...
  public static String getLabelFromWednesday(final String language, final String key) {
