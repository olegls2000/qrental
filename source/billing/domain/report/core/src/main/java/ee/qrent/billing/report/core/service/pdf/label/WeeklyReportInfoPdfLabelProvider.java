  ...
  static {
    mapRus =
        Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>(REPORT_NAME_KEY, "Информационное письмо "),
    ...
    mapEng =
        Map.ofEntries(
            ...
            new AbstractMap.SimpleEntry<>(REPORT_NAME_KEY, "information letter"),
    ...
    mapEst =
        Map.ofEntries(
            new AbstractMap.SimpleEntry<>(CURRENCY_NAME_KEY, "euro"),
            new AbstractMap.SimpleEntry<>(REPORT_NAME_KEY, "Infokiri"),
