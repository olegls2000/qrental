...
public class InvoiceToPdfConverter {
    ...
    public InputStream getPdfInputStream(final InvoicePdfModel model) {
        final var invoicePdfDoc = new Document(A4, 40f, 40f, 10f, 10f);
        ...
        final var block2 =
                getBlock2(
                        model.getFeeStartDate(), model.getBlock2A(), model.getBlock2B(), model.getBlock2C());
        final var block21 =
                getBlock21(
                        model.getAdvancePayment(), model.getDebt());

        final var block3 = getBlock3(model.getSumWithVat(), model.getTotal());
        final var block4 =
                getBlock4(
    ...
    private Table getBlock1(
        ...
        final var table = new Table(2);
        table.setWidths(new float[]{11, 2});
        table.setSpacing(-1f);
        table.setPadding(0f);
        table.setWidth(90f);
        ...
        table.addCell(getSummLabelCell("Jooksvate kohustuste summa koos KM-ga"));
    ...
    private Table getBlock4(
        ...
        table.addCell(
                getTotalLabelCell(String.format("Eelmise nädala alguseks (kuni %s) tasumata viiviste üldsumma", feeStartPeriod)));
    ...
    private Table getBlock2(
        ...
        table.addCell(getTotalLabelCell("Eelmise nädala saldo koos KM-ga"));
        table.addCell(getTotalValueCell(a.subtract(b).subtract(c)));

        return table;
    }

    private Table getBlock21(
