...
import ee.qrent.billing.invoice.adapter.adapter.InvoiceCalculationLoadAdapter;
import ee.qrent.billing.invoice.adapter.adapter.InvoiceCalculationPersistenceAdapter;
import ee.qrent.billing.invoice.adapter.adapter.InvoiceLoadAdapter;
import ee.qrent.billing.invoice.adapter.adapter.InvoicePersistenceAdapter;
