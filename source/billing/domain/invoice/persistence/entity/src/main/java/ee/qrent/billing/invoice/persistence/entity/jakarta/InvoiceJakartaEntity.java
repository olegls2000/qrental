...
public class InvoiceJakartaEntity {
    ...
    @Column(name = "previous_week_all_positive_transactions_sum")
    private BigDecimal previousWeekAllPositiveTxSum;

    @Column(name = "previous_week_all_negative_transactions_sum")
    private BigDecimal previousWeekAllNegativeTxSum;
