...
public class InvoiceAdapterMapper {
    ...
    public Invoice mapToDomain(final InvoiceJakartaEntity entity) {
        ...
        return Invoice.builder()
                ...
                .previousWeekAllPositiveTxSum(entity.getPreviousWeekAllPositiveTxSum())
                .previousWeekAllNegativeTxSum(entity.getPreviousWeekAllNegativeTxSum())
    ...
    public InvoiceJakartaEntity mapToEntity(final Invoice domain) {
        return InvoiceJakartaEntity.builder()
                ...
                .previousWeekAllPositiveTxSum(domain.getPreviousWeekAllPositiveTxSum())
                .previousWeekAllNegativeTxSum(domain.getPreviousWeekAllNegativeTxSum())
