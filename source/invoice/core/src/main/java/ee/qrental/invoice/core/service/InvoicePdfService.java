...
public class InvoicePdfService implements InvoicePdfUseCase {
    ...
    public InputStream getPdfInputStreamById(final Long id) throws IOException {
        ...
        final var invoicePdfDoc = new Document(PageSize.A4,
                40f,   // left
                40f,   // right
                50f,  // top
                50f); // down);
        ...
        Cell cell1 = new Cell(new Paragraph("Arve Nr.: " + invoiceNumber, new Font(Font.TIMES_ROMAN, 14, Font.BOLD)));
        cell1.setBorder(Rectangle.NO_BORDER);
        invoiceTable1.addCell(cell1);

        Cell cell2 = new Cell(new Paragraph("Data : " + invoiceDate, new Font(Font.TIMES_ROMAN, 14, Font.BOLD)));
        cell2.setBorder(Rectangle.NO_BORDER);
        invoiceTable1.addCell(cell2);

        Cell cell3 = new Cell(new Paragraph("Ajaperiood: " + "Date-Date/Month/Year", new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
...
// Table 2
        ...
        Cell cell22 = new Cell(new Paragraph(invoiceDriverCompany, new Font(Font.COURIER, 11, Font.BOLDITALIC)));
        ...
        Cell cell24 = new Cell(new Paragraph(invoiceDriverCompanyAddress, new Font(Font.COURIER, 11, Font.BOLDITALIC)));
        cell24.setBorder(Rectangle.NO_BORDER);
        cell24.setHorizontalAlignment(HorizontalAlignment.LEFT);
        invoiceTable2.addCell(cell24);

        Cell cell25 = new Cell(new Paragraph("Äriregistri nr: ", new Font(Font.TIMES_ROMAN, 11, Font.BOLD)));
        cell25.setBorder(Rectangle.NO_BORDER);
        cell25.setHorizontalAlignment(HorizontalAlignment.LEFT);
        invoiceTable2.addCell(cell25);

        Cell cell26 = new Cell(new Paragraph(invoiceDriverCompanyRegNumber, new Font(Font.COURIER, 11, Font.BOLDITALIC)));
...
// Main Table
        ...
        Cell cell31 = new Cell(new Paragraph("Renditasu ", new Font(Font.TIMES_ROMAN, 12, Font.NORMAL)));
...
// Summa Table
        ...
        Cell cell8 = new Cell(new Paragraph("Arve summa EUR:", new Font(Font.TIMES_ROMAN, 11, Font.BOLD)));
...
// Total Table
        Cell cell10 = new Cell(new Paragraph("Eelmise perioodi ettemaks:", new Font(Font.TIMES_ROMAN, 11, Font.BOLD)));
        ...
        Cell cell12 = new Cell(new Paragraph("Eelmise perioodi võlgnevus:", new Font(Font.TIMES_ROMAN, 11, Font.BOLD)));
        ...
        Cell cell16 = new Cell(new Paragraph("Tasuda kokku:", new Font(Font.TIMES_ROMAN, 11, Font.BOLD)));
