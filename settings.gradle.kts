...
include("source:driver:persistence:repository:spring")
...
include("source:car:persistence:repository:spring")
...
include("source:firm:persistence:repository:spring")
...
include("source:link:persistence:repository:spring")
...
include("source:constant:persistence:repository:spring")
...
include("source:callsign:persistence:repository:spring")
...
include("source:invoice:persistence:repository:spring")
...
include("source:transaction:persistence:repository:spring")
